            ...
            <div class="col-md">
                <form action="/library/ConfirmNewMemberController" method="post">
                    <div class="form-group">
                        ...
                        <label>郵便番号：</label>
                        <input type="text" class="form-control input-sm" name="postal" size="15">
                        <label>住所：</label>
                        <input type="text" class="form-control input-sm" name="address" size="15">
                        <label>電話番号：</label>
                        <div class="col-sm-12 form-inline">
                        <input type="text" class="form-control input-sm col-sm-3 " name="tel_1" size="15">-<input type="text" class="form-control input-sm col-sm-3 " name="tel_2" size="15">-<input type="text" class="form-control input-sm col-sm-3 " name="tel_3" size="15">
                        </div>
                        <label>メールアドレス：</label>
                        <div class="col-sm-12 form-inline">
                        <input type="text" class="form-control input-sm col-sm-4 " name="email_1" size="15">@<input type="text" class="form-control input-sm col-sm-4 " name="email_2" size="15">
                        </div>
                        <label>生年月日：</label>
                        <div class="col-sm-12 form-inline">
		            ...
		            <div class="col-5">
		                <button type="submit" class="btn btn-outline-secondary btn-block">確認画面へ進む</button>
		            </div>
           		</form>
       		</div>
        <br>
